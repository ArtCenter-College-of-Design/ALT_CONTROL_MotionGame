...
namespace Kinect {
	...
	public class NativeMethods
	{
		...
		[DllImport("YuYuYouEr_Kinect_SDK_Wrapper")]
		public static extern bool qfKinectGetEnableBackgroundRemoval_multiUser();

		[DllImport("YuYuYouEr_Kinect_SDK_Wrapper")]
		public static extern void qfKinectSetEnableBackgroundRemoval_multiUser(bool bEnable);
		...
		[DllImport("YuYuYouEr_Kinect_SDK_Wrapper")]
		public static extern int qfKinectGetBackgroundRemovalParam_smooth();

		[DllImport("YuYuYouEr_Kinect_SDK_Wrapper")]
		public static extern void qfKinectSetBackgroundRemovalParam_smooth(int smooth);

		[DllImport("YuYuYouEr_Kinect_SDK_Wrapper")]
		public static extern int qfKinectGetBackgroundRemovalParam_cutout();

		[DllImport("YuYuYouEr_Kinect_SDK_Wrapper")]
		public static extern void qfKinectSetBackgroundRemovalParam_cutout(int cutout);
